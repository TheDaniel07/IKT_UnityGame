...
public class SmeltingMenuManager : MonoBehaviour
{
    ...
    public void OpenMenu()
    {
        ...
        _isOpen = true;
        RefreshList();
        Debug.Log("[SmeltingMenuManager] Menu opened.");
    }
    ...
    private void RefreshList()
    {
        ...
        foreach (var recipe in RecipeDatabase.SmeltingRecipes)
        {
            bool canSmelt = RecipeDatabase.CanCraft(recipe);
